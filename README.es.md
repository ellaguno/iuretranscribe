...
- Interfaz en inglés y español: por defecto en inglés, en español si el sistema
  operativo está en español; se puede elegir en Ajustes → Idioma. El idioma de la
  interfaz es independiente del idioma del audio que se transcribe, y el resumen y la
  minuta se redactan en el idioma de la transcripción.
